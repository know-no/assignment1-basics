...
def run_embedding(
    ...
    embd.weights = torch.nn.Parameter(weights)
...
def run_scaled_dot_product_attention(
    ...
    """
    return scale_dot_production_attention(Q,K,V,mask)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return soft_max_stable(in_features)
    # return soft_max_normal(in_features)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    clip_gradient(parameters=parameters, max_l2_norm=max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return schedule_learning_rate(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
